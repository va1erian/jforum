...
public class AppModule {
    ...
    public static void bind(ServiceBinder binder) {
        ...
        binder.bind(PostDAO.class, PostDAOHibernateImpl.class);
        binder.bind(BoardDAO.class, BoardDAOHibernateImpl.class);
        binder.bind(TopicDAO.class, TopicDAOHibernateImpl.class);
        binder.bind(UserDAO.class, UserDAOHibernateImpl.class);
    ...
    public static void contributeApplicationDefaults(
        ...
        configuration.add(SymbolConstants.HMAC_PASSPHRASE, "top-kek");
    }
    ...
    public static void contributeComponentRequestHandler(
        ...
        configuration.addInstance("RequiresAuthentication", RequiresAuthenticationFilter.class);
    }
